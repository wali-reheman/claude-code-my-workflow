...
|----------|----------------|-------------------|
| `master_supporting_docs/supporting_papers/` | Academic papers and methodology references | User uploads |
| `master_supporting_docs/codebooks/` | Existing codebooks from benchmark datasets | User uploads |
...
- Only read those sections in detail for dataset construction
...
- Ask user which sections matter most for their dataset construction
