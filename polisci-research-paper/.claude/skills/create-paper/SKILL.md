...
**End-to-end manuscript creation orchestrator.** The researcher drives the vision, Claude orchestrates the pipeline, and quality gates ensure nothing ships broken.
