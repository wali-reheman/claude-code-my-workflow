...
- [ ] Estimator implementations match the equations in the manuscript
...
- [ ] Explicit dimensions in ggsave() for reproducible figure sizing
...
- [ ] Missing `saveRDS()` for computed objects — flag as HIGH severity

**Flag:** Missing `saveRDS()` for any computed object needed downstream.
