...
3. **Skill delegation** — when a skill like `/create-paper` or `/prep-data` reaches its implementation phase, the orchestrator loop governs execution.
...
- [e.g., "Run /reviewer-2 for methodology review"]
```
