...
|----------|----------------|-------------------|
| `master_supporting_docs/supporting_papers/` | Academic papers for research and literature review | User uploads |
...
- Only read those sections in detail for analysis
...
- Ask user which sections matter most for their research
